<?php 
    ...
    $sql = "SELECT product.*,category.Ten as namecate FROM product LEFT JOIN category on category.id=product.id_hang ";
        ...
        <div class="content-wrapper">           
            <div class="container-fluid">
                ...
                <div class="card-header">
                    <i class=""></i>  <b>Sản phẩm</b>   <a href="add.php" class="btn btn-success"> Thêm mới</a>                 
                <div class="">
                    <i class=""></i>    
